...
import userModel from "../models/userModel.js";
 export default {
  ...
  doUserUnBlock: async (id) => {
    ...
    addproduct : async ({productName,Description,productPrice,quantity,category},urls) => {
    const productSchema = new productModel({
      productName,Description,productPrice,quantity,category,coverImage:urls[0],imageOne:urls[1],imageTwo:urls[2]
    })
